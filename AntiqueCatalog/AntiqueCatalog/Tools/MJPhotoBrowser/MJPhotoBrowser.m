...
- (void)photoViewKnowledgeChart:(NSString *)stringKnowledgeChart
{
    
    NSString * str = [stringKnowledgeChart stringByReplacingOccurrencesOfString:@":" withString:@"%3A"];
    NSString * str1 = [str stringByReplacingOccurrencesOfString:@"/" withString:@"%2F"];
    NSString * str2 = [str1 stringByReplacingOccurrencesOfString:@"!" withString:@"%21"];
    NSString * str3 = [str2 stringByReplacingOccurrencesOfString:@"?" withString:@"%3F"];
    
    NSString *string = [NSString stringWithFormat:baiDuShiTuUrl,str3];
//    NSLog(@"%@",string);
    SDWebViw *sdwebview = [[SDWebViw alloc]initWithUrlString:string];
    sdwebview.frame = CGRectMake(0, UI_SCREEN_HEIGHT, UI_SCREEN_WIDTH, UI_SCREEN_HEIGHT);
//    NSLog(@"%@",sdwebview.urlString);
    [self.view addSubview:sdwebview];
    
    [UIView animateWithDuration:1 animations:^{
        sdwebview.frame = CGRectMake(0, 0, UI_SCREEN_WIDTH, UI_SCREEN_HEIGHT);
    }];
