...
// appkey 是在rqd的页面（rqd.uu.qq.com）注册产品时生成的
// 只有合法的appkey才能启用crash捕获等功能
...
//上报Unity异常
- (void)reportUnityExceptionWithName:(NSString *)name reason:(NSString *)reason stack:(NSString *)stacks;
