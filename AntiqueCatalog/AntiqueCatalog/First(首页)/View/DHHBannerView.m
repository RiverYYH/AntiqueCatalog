...
@interface DHHBannerView () <UIScrollViewDelegate>

@property (nonatomic, weak) id<DHHBannerViewDelegate> delegate;
...
@implementation DHHBannerView

+ (instancetype)bannerViewWithFrame:(CGRect)frame delegate:(id<DHHBannerViewDelegate>)delegate imageName:(NSString *)imageName count:(NSInteger)count timerInterval:(NSInteger)timeInterval currentPageIndicatorTintColor:(UIColor *)currentPageIndicatorTintColor pageIndicatorTintColor:(UIColor *)pageIndicatorTintColor {
...
+ (instancetype)bannerViewWithFrame:(CGRect)frame delegate:(id<DHHBannerViewDelegate>)delegate imageURLs:(NSArray *)imageURLs placeholderImage:(NSString *)placeholderImage timerInterval:(NSInteger)timeInterval currentPageIndicatorTintColor:(UIColor *)currentPageIndicatorTintColor pageIndicatorTintColor:(UIColor *)pageIndicatorTintColor {
...
- (instancetype)initWithFrame:(CGRect)frame delegate:(id<DHHBannerViewDelegate>)delegate imageName:(NSString *)imageName count:(NSInteger)count timerInterval:(NSInteger)timeInterval currentPageIndicatorTintColor:(UIColor *)currentPageIndicatorTintColor pageIndicatorTintColor:(UIColor *)pageIndicatorTintColor {
...
- (instancetype)initWithFrame:(CGRect)frame delegate:(id<DHHBannerViewDelegate>)delegate imageURLs:(NSArray *)imageURLs placeholderImage:(NSString *)placeholderImage timerInterval:(NSInteger)timeInterval currentPageIndicatorTintColor:(UIColor *)currentPageIndicatorTintColor pageIndicatorTintColor:(UIColor *)pageIndicatorTintColor {
...
- (void)setupMainView {
    ...
    [self addSubview:({
        ...
        UIScrollView *scrollView = [[firstScrollView alloc] initWithFrame:CGRectMake(0, 0, scrollW, scrollH)];
